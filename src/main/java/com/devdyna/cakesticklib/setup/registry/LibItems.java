...
public class LibItems {
        ...
        public static final DeferredHolder<Item, Item> SPEED_UPGRADE = zUpgrades.registerSimpleItem("speed_upgrade");
        public static final DeferredHolder<Item, Item> ENERGY_UPGRADE = zUpgrades.registerSimpleItem("energy_upgrade");
        public static final DeferredHolder<Item, Item> LUCK_UPGRADE = zUpgrades.registerSimpleItem("luck_upgrade");
        public static final DeferredHolder<Item, Item> FLUID_UPGRADE = zUpgrades.registerSimpleItem("fluid_upgrade");
        public static final DeferredHolder<Item, Item> EJECT_UPGRADE = zUpgrades.registerSimpleItem("eject_upgrade");
