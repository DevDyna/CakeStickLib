...
public class ColorUtil {
    ...
    public static int rgbColor() {
        return rgbColor((int) (TimeUtil.ONE_SECOND*2));
    }

    public static int rgbColor(int delay) {
        return java.awt.Color.HSBtoRGB((System.currentTimeMillis() % delay) / (delay * 1f), 1.0f, 1.0f)
                & 0xFFFFFF;
    }
